...
# as a continuous variable (beginning vs. end of month - linear)
...
## Get 95% CI for 'meal_plannone,', 'btw_time,' 'room_price_usd,' 'special_req'
# meal_planhalf 
...
contrasts(hotel_test$booking_status)
...
# Note: Higher error rate for 'cancelled' but 500 trees seems good (stay with default ntree)
```
